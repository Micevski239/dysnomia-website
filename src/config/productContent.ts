// Static content for product detail pages
...
If you're interested in commissioning a custom piece or have special requests, we'd love to hear from you.`,

  supportMk: `За прашања за одредено уметничко дело, димензии или достава, контактирајте нè на contact_dysnomia@yahoo.com

Обично одговараме во рок од 24-48 часа.

Доколку сте заинтересирани за нарачка на парче по мерка или имате посебни барања, би сакале да слушнеме од вас.`,
};
